...
export default {
  ...
  callback: async ({ client, channel, interaction: msgInt, instance }) => {
      ...
      .addFields([
        {
          name: "About",
          value:
            "Here you will find all the commands to control Antares Bot in your server",
        },
        {
    ...
    const configEmbed = new MessageEmbed()
      ...
      .setColor("#ff3505")
      .setDescription(
        `**admin**: Sets the server's admin channel` +
    ...
    const countingEmbed = new MessageEmbed()
      ...
      .setColor("#ff3505")
      .setDescription(
        `**counting**: Creates a channel called Counting in your server. Also sends an embed with the rules of the game` +
